...
$(document).ready(function() {
    ...
    $("#work_item_1").hover(function() {
        ...
        $("#work_item_label_1").css({height: "100%", clipPath: "polygon(0 0, 100% 0, 100% 58%, 0 42%)"});
    ...
    $("#work_item_2").hover(function() {
        ...
        $("#work_item_label_2").css({height: "100%", clipPath: "polygon(0 0, 100% 0, 100% 58%, 0 42%)"});
    ...
    $("#work_item_3").hover(function() {
        ...
        $("#work_item_label_3").css({height: "100%", clipPath: "polygon(0 0, 100% 0, 100% 58%, 0 42%)"});
    ...
    $("#work_item_4").hover(function() {
        ...
        $("#work_item_label_4").css({height: "100%", clipPath: "polygon(0 0, 100% 0, 100% 58%, 0 42%)"});
    ...
    $("#work_item_5").hover(function() {
        ...
        $("#work_item_label_5").css({height: "100%", clipPath: "polygon(0 0, 100% 0, 100% 58%, 0 42%)"});
